...
public:
	...
	vector<int> inOrderTraverse(vector<int> array)
	{
		// Write your code here.
		if (this != nullptr)
		{
			if (this->left)
			{
				array = this->left->inOrderTraverse(array);
			}
			array.push_back(this->value);
			if (this->right)
			{
				array = this->right->inOrderTraverse(array);
			}
		}
	...
	vector<int> preOrderTraverse(vector<int> array) {
		// Write your code here.
	}

	vector<int> postOrderTraverse(vector<int> array) {
		// Write your code here.
	}
};
